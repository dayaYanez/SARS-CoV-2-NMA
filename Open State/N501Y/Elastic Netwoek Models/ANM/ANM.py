...
openS = parsePDB('/home/daya/Documentos/NORMALCOV/Correccion/Open State Mutation/mutations/N501Y/Elastic Netwoek Models/ANM/openN.pdb')

calphas = openS.select('protein and name CA')
calphas2 = openS.select('calpha')

if calphas==calphas2:
	anm = ANM('Opens State N501Y ANM analysis')
