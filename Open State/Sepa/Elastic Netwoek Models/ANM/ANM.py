...
openS = parsePDB('/home/daya/Documentos/NORMALCOV/Correccion/Open State Mutation/mutations/Sepa/Elastic Netwoek Models/ANM/openS.pdb')

calphas = openS.select('protein and name CA')
calphas2 = openS.select('calpha')

if calphas==calphas2:
	anm = ANM('Opens State Sepa ANM analysis')
