...
openS = parsePDB('/home/daya/Documentos/NORMALCOV/Correccion/Close state mutation/sepa/Elastic Netwoek Models/ANM/closeS.pdb')

calphas = openS.select('protein and name CA')
calphas2 = openS.select('calpha')

if calphas==calphas2:
	anm = ANM('Close State Sepa ANM analysis')
