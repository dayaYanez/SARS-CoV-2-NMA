...
openS = parsePDB('/home/daya/Documentos/NORMALCOV/Correccion/Close state mutation/N201Y-D614G/Elastic Netwoek Models/ANM/closeND.pdb')

calphas = openS.select('protein and name CA')
calphas2 = openS.select('calpha')

if calphas==calphas2:
	anm = ANM('Close State N201Y-D614G ANM analysis')
